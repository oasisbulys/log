...
![System Boot](https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;700&display=swap) <!-- Placeholder for a screenshot if available, otherwise just text -->
